...
stocks_train_diff <- stocks_train %>% select(Date, '6', '8') %>% drop_na() ##only checking for two stocks right now, how to tackle NA
...
var_model <- VAR(stocks_train_diff, lag.max = 12)
